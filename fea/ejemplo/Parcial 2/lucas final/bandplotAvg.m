...
%            elementos. Utilizar 'none' para no mostrar los bordes.
...
for iele=1:size(elementos,1)
    ...
    h = patch('Faces',faces,'Vertices',verts,'FaceVertexCData',variable(elementos(iele,:)));
    set(h,'FaceColor','interp','EdgeColor',lineColor,'CDataMapping','scaled');
end
